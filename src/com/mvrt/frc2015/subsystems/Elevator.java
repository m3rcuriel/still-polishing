...
public class Elevator extends Subsystem implements Runnable {
  ...
  public Elevator() {
    ...
    // speedController = = new AbstractSpeedController(new
    // CANTalon[]{elevatorDrive1, elevatorDrive2},
    // new int[]{Constants.kElevatorDrive1PDP,
    // Constants.kElevatorDrive2PDP});
  ...
  public synchronized void setPositionSetpoint(double setpoint, boolean brakeOnTarget) {
    ...
    if (!(controller instanceof TrajectoryFollowingPositionController)) {
      ...
      controller =
          new TrajectoryFollowingPositionController(Constants.kElevatorPositionKp,
              Constants.kElevatorPositionKi, Constants.kElevatorPositionKd,
              Constants.kElevatorPositionKv, Constants.kElevatorPositionKa,
  ...
  public void run() {
    if (controller instanceof TrajectoryFollowingPositionController) {
      TrajectoryFollowingPositionController positionController =
          (TrajectoryFollowingPositionController) controller;
